...
public class Thermalexpansion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thermalexpansion);
        Toolbar toolbar = (Toolbar) findViewById(R.id.phy_lawtoolbar);
        setSupportActionBar(toolbar);
        setTitle(R.string.Thermalexpansion);
        ...
        webView.loadUrl("file:///android_asset/mathscribe/Thermalexpansion.html");
    }
    @Override
