...
public class Modernphysics extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modernphysics);
        ...
        webView.loadUrl("file:///android_asset/mathscribe/Modernphysics.html");
    }
    @Override
