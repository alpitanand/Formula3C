...
public class Electromagneticwaves extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electromagneticwaves);
        Toolbar toolbar = (Toolbar) findViewById(R.id.phy_lawtoolbar);
        setSupportActionBar(toolbar);
        setTitle(R.string.Electromagneticwaves);
        ...
        webView.loadUrl("file:///android_asset/mathscribe/Emw.html");
    }
    @Override
